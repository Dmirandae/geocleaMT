#'@name America
#'
#'@title Vectorial layer: American continent
#'
#'@description Map of the American continent. Shapefile of countries borders. This map was
#'extracted from data(wrld_simpl) from maptools package [1]. The \code{'America'} object uses the WGS84
#' datum.
#'
#' @docType data
#'
