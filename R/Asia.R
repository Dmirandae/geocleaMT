#'@name Asia
#'
#'@title Vectorial layer: Asian continent
#'
#'@description Map of the Asian continent. Shapefile of countries borders. This map was
#'extracted from data(wrld_simpl) from maptools package [1]. The \code{'Asia'} object uses the WGS84
#' datum.
#'
#' @docType data
#'
